...
$des=$_POST['des'];
 $query=mysqli_query($con,"insert into tblvisitor(FullName,MobileNumber,des) value('$fullname','$mobnumber','$des')");
    ...
    if ($query) {
    $msg="Teacher Detail has been added.";
  }
  else
    {
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header" align='center'>
                                        <strong style="text-transform: uppercase; letter-spacing: 0.4px;">Add New Teacher</strong>
                                    </div>
...
echo "<div class='alert alert-light' role='alert' style='font-size:16px; background: #000; color: #fff;margin-bottom: 18px;'> $msg</div>";
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Teacher Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="fullname" name="fullname" placeholder="Enter Teacher Full Name" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="mobilenumber" placeholder="Enter Teacher Mobile Number" class="form-control" maxlength="10" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                <input name="des" value="Teacher" placeholder="Enter Visitor Address" class="form-control" required="" readonly>
