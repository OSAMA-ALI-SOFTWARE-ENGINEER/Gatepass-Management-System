...
if (strlen($_SESSION['cvmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            $msg = "Visitor Detail has been added.";
        } else {
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header" align='center'>
                                            <strong style="text-transform: uppercase; letter-spacing: 0.4px;">Add New
                                                Visitor</strong>
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="" method="post" enctype="multipart/form-data"
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input class="form-control" name="des" value="Vistor" required="" readonly>
                                                </div>
                                                </div>
