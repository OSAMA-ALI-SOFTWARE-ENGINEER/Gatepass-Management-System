<?php
   ...
   $rollno=$_POST['rollno'];
    $query=mysqli_query($con,"insert into tblvisitor(FullName,rollno,MobileNumber,Deptartment,des) value('$fullname','$rollno','$mobnumber','$department','$designation')");
       if ($query) {
       $msg="Student Detail has been added.";
     }
     else
       {
                        ...
                        <div class="col-lg-12">
                           <div class="card">
                              <div class="card-header" align='center'>
                                 <strong style="text-transform: uppercase; letter-spacing: 0.4px;">Add New Student</strong>
                              </div>
                                 ...
                                 <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                          <input type="text" id="fullname" name="fullname" placeholder="Enter Student Full Name" class="form-control" required="">
                                       </div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3">
                                    ...
                                    <div class="row form-group">
                                       <div class="col col-md-3">
                                          <label for="input" class="form-control-label">Roll Number</label>
                                       </div>
                                       <div class="col-12 col-md-9">
                                          <input type="text" id="rollno" name="rollno" placeholder="Enter Student Roll Number" class="form-control" maxlength="15" required="">
                                       </div>
                                    </div>
                                    <!-- <div class="row form-group">
                                       <div class="col col-md-3">
                                    ...
                                    <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                          <input name="designation" value="Student" placeholder="Enter Visitor Address" class="form-control" required="" readonly>
                                       </div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3">
